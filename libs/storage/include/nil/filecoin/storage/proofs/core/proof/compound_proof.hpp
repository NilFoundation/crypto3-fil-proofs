...
namespace filecoin {
    ...
    template<typename ProofScheme, template<typename> class Circuit, typename Bls12, typename ComponentsPrivateInputs>
    struct compound_proof {
        ...
        multi_proof<groth16::mapped_parameters<Bls12>>
            prove(const public_params_type &pp, const public_inputs_type &pub_in, const private_inputs_type &priv_in,
                  const groth16::mapped_parameters<Bls12> &groth_parameters) {
        ...
        bool verify(const public_params_type &pp, PublicInputsIterator pifirst, PublicInputsIterator pilast,
            ...
            assert(std::accumulate(mpfirst, mplast, true,
    ...
    to those allocated when C is synthesized.
         ...
         * @return
         */
        std::vector<fr> generate_public_inputs(const public_inputs_type &pub_in, const public_params_type &pub_params,
    ...
    present.
        ...
        /*!
         * @brief If the rng option argument is set, parameters will be generated using it.  This is used for testing
